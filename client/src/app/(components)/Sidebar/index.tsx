...
import { Archive, Clipboard, Icon,IndianRupee,Layout,LucideIcon, Menu, SlidersHorizontal, User } from "lucide-react";
  ...
  return (
    <div className={sidebarClassNames}>
      ...
      <div className={`flex gap-3 justify-between md:justify-normal items-center pt-8 ${isSidebarCollapsed ? 'px-5' : 'px-8'}`}>
        ...
        <button
          className="md:hidden px-3 py-3 bg-gray-100 text-gray-700 rounded-full hover:bg-blue-100"
      ...
      <div className={`${isSidebarCollapsed ? 'hidden' : 'block'} mb-10`}>
        <p className="text-center text-xs text-gray-500">&copy; 2026 Edstock</p>
      </div>
    </div>
  );
};
